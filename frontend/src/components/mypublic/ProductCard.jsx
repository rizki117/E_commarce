...
const ProductCard = ({ title, price, oldPrice, image, isSale, onDetailClick }) => {
  ...
  return (
    ...
    >
      ...
      <Card.Img
        variant="top"
        src={`${import.meta.env.VITE_BASE_IMAGE_URL}${image}`}
      ...
      <Card.Body className="text-center d-flex flex-column">
        ...
        <Button variant="dark" className="mt-auto w-100" onClick={onDetailClick}>
